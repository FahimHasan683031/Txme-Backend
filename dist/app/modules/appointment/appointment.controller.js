...
const getCurrentAppointment = (0, catchAsync_1.default)(async (req, res) => {
    const result = await appointment_service_1.AppointmentService.getCurrentAppointment(req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
