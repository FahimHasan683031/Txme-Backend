...
router.get("/reference/:referenceId", (0, auth_1.default)(user_1.USER_ROLES.CUSTOMER, user_1.USER_ROLES.PROVIDER), transaction_controller_1.TransactionController.getTransactionByReference);
// Download transaction invoice (Customer & Provider)
router.get("/invoice/:transactionId", (0, auth_1.default)(user_1.USER_ROLES.CUSTOMER, user_1.USER_ROLES.PROVIDER), transaction_controller_1.TransactionController.downloadInvoice);
